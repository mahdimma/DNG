...
const transportationMethods = [
  {
    ...
    title: 'با ماشین',
    icon: '🚗',
    description: 'از [نزدیکترین شهر] وارد بزرگراه [X] شوید. از خروجی [نام خروجی] خارج شده و علائم را به سمت روستای دنگپیا دنبال کنید. فاصله کل: تقریباً [X] کیلومتر.',
    bgColor: 'bg-blue-50',
  ...
  },
  {
    ...
    icon: '🚌',
    description: 'سرویس اتوبوس منظم از [نزدیکترین شهر] به روستای دنگپیا. اتوبوس‌ها هر [X] ساعت حرکت می‌کنند. زمان سفر: تقریباً [X] دقیقه.',
    bgColor: 'bg-green-50',
