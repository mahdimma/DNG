...
const PrivacyPolicyPage = () => {
  return (
    <Layout title="سیاست حفظ حریم خصوصی" description="سیاست حفظ حریم خصوصی وبسایت روستای دنگپیا">
      <HeroSection 
          ...
          <div className="grid grid-cols-1 gap-8">
            <div className="card">
              ...
              <p className="text-gray-700 leading-relaxed">
                روستای دنگپیا («ما»، «ماهای» یا «ماهاییم») متعهد به حفاظت از حریم خصوصی شما است. این سیاست حفظ حریم خصوصی چگونگی جمع‌آوری، استفاده و افشاء اطلاعات شخصی شما توسط وبسایت روستای دنگپیا را توضیح می‌دهد.
              </p>
            </div>
