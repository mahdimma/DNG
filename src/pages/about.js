...
import VillageInfoSection from "../components/VillageInfoSection"

const AboutPage = () => {
  return (
    <Layout title="درباره ما" description="درباره روستای دنگپیا، تاریخ، فرهنگ و جامعه آن بیاموزید">
      {/* Hero Section */}
      <HeroSection 
        title="درباره روستای دنگپیا"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 leading-relaxed text-justify">
                روستای دنگپیا دارای تاریخ غنی و قدمتی چندین قرنه است. این روستا از گذشته‌های دور
        ...
        <section className="mb-16 bg-gray-50 -mx-4 sm:-mx-6 lg:-mx-8 px-4 sm:px-6 lg:px-8 py-16">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg text-gray-600 leading-relaxed text-justify mb-12">
              روستای دنگپیا میراث فرهنگی خود را از طریق جشنواره‌ها، جشن‌ها و آداب سنتی مختلف
          ...
          <section>
            ...
            <div className="card h-full">
              ...
              <p className="text-gray-600 leading-relaxed text-justify">
                روستای دنگپیا در محیطی طبیعی زیبا قرار دارد و مناظر خیره‌کننده و محیطی آرام
