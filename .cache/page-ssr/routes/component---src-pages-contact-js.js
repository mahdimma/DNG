...
const Container = styled_components__WEBPACK_IMPORTED_MODULE_2__["default"].div`
  ...
  padding: 2rem 1rem;
`;
const GridContainer = styled_components__WEBPACK_IMPORTED_MODULE_2__["default"].div`
  display: grid;
...
`;
const FormSection = styled_components__WEBPACK_IMPORTED_MODULE_2__["default"].div`
  h2 {
    margin-bottom: 1rem;
  }
`;
...
`;
const InfoCard = styled_components__WEBPACK_IMPORTED_MODULE_2__["default"].div`
  background: #f7fafc;
  padding: 2rem;
  border-radius: 8px;
  margin-bottom: 2rem;
...
`;
const EmergencyCard = styled_components__WEBPACK_IMPORTED_MODULE_2__["default"].div`
  background: #fed7d7;
  padding: 2rem;
  border-radius: 8px;
...
`;
const SuccessMessage = styled_components__WEBPACK_IMPORTED_MODULE_2__["default"].div`
  background: #c6f6d5;
  color: #22543d;
  padding: 1rem;
  border-radius: 5px;
...
`;
const MapSection = styled_components__WEBPACK_IMPORTED_MODULE_2__["default"].section`
  margin-top: 3rem;
  background: #f7fafc;
  padding: 2rem;
  border-radius: 8px;
  text-align: center;
`;
const MapPlaceholder = styled_components__WEBPACK_IMPORTED_MODULE_2__["default"].div`
  background: #e2e8f0;
  height: 300px;
  border-radius: 8px;
  display: flex;
