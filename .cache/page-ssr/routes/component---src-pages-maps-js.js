"use strict";
exports.id = "component---src-pages-maps-js";
exports.ids = ["component---src-pages-maps-js"];
exports.modules = {
...
/***/ "./src/pages/maps.js?export=default":
/*!******************************************!*\
  !*** ./src/pages/maps.js?export=default ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const MapsPage = () => {
  ...
  const filteredLocations = filter === "All" ? locations : locations.filter(location => location.type === filter);
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_Layout__WEBPACK_IMPORTED_MODULE_1__["default"], {
    title: "Village Maps",
    description: "Interactive maps and location guide for Dangepia Village"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    style: {
      maxWidth: 1200,
      margin: `0 auto`,
  ...
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h1", null, "Village Maps & Locations"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", {
    style: {
      fontSize: `1.1rem`,
      marginBottom: `3rem`
    }
  }, "Explore Dangepia Village with our interactive maps and location guide. Find important buildings, services, and points of interest."), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    style: {
      display: `flex`,
      gap: `0.5rem`,
      marginBottom: `2rem`,
  ...
  }, locationTypes.map((type, index) => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("button", {
    key: index,
  ...
  }, type.type))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    style: {
      display: `grid`,
  ...
  }, "\uD83D\uDDFA\uFE0F"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h3", null, "Interactive Village Map"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", null, "Map integration would be implemented here"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", {
    style: {
      fontSize: `0.9rem`,
      marginTop: `1rem`
    }
  }, "This would typically integrate with services like:"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("ul", {
    style: {
      textAlign: `left`,
      marginTop: `1rem`
    }
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li", null, "Google Maps"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li", null, "OpenStreetMap"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li", null, "Mapbox"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li", null, "Local mapping services")))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    style: {
      marginTop: `1rem`,
      width: `100%`,
      background: `white`,
  ...
  }, "Map Legend"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    style: {
      display: `grid`,
      gridTemplateColumns: `repeat(auto-fit, minmax(150px, 1fr))`,
      gap: `0.5rem`
    }
  }, locationTypes.slice(1).map((type, index) => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    key: index,
    style: {
      display: `flex`,
      alignItems: `center`,
  ...
  }, type.type)))))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h3", null, "Points of Interest"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    style: {
      maxHeight: `600px`,
      overflowY: `auto`
    }
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      key: location.id,
      style: {
        background: (selectedLocation === null || selectedLocation === void 0 ? void 0 : selectedLocation.id) === location.id ? `#f0fff4` : `white`,
        border: `1px solid ${(selectedLocation === null || selectedLocation === void 0 ? void 0 : selectedLocation.id) === location.id ? locationTypeData === null || locationTypeData === void 0 ? void 0 : locationTypeData.color : '#e2e8f0'}`,
        borderRadius: `8px`,
        padding: `1rem`,
        marginBottom: `1rem`,
        cursor: `pointer`,
      ...
      onMouseOver: e => {
        if ((selectedLocation === null || selectedLocation === void 0 ? void 0 : selectedLocation.id) !== location.id) {
          e.currentTarget.style.background = '#f7fafc';
          e.currentTarget.style.borderColor = locationTypeData === null || locationTypeData === void 0 ? void 0 : locationTypeData.color;
        }
      },
      onMouseOut: e => {
        if ((selectedLocation === null || selectedLocation === void 0 ? void 0 : selectedLocation.id) !== location.id) {
      ...
      style: {
        ...
        height: `12px`,
        borderRadius: `50%`,
        background: locationTypeData === null || locationTypeData === void 0 ? void 0 : locationTypeData.color,
        marginTop: `0.3rem`,
        flexShrink: 0
      }
    ...
    }, location.name), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", {
      style: {
        margin: `0 0 0.5rem 0`,
        fontSize: `0.9rem`,
        color: `#4a5568`
      }
    }, location.description), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      style: {
        fontSize: `0.8rem`,
        color: `#666`
      }
    ...
    }, "\uD83D\uDCCD ", location.address), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
      style: {
        marginBottom: `0.25rem`
      }
    }, "\uD83D\uDD52 ", location.hours), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null, "\uD83D\uDCDE ", location.phone)))));
  ...
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h3", null, "Getting to Dangepia Village"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    style: {
      display: `grid`,
  ...
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h4", null, "\uD83D\uDE97 By Car"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", null, "Take Highway [X] from [Nearest City]. Exit at [Exit Name] and follow the signs to Dangepia Village. Total distance: approximately [X] km.")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h4", null, "\uD83D\uDE8C By Public Transportation"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", null, "Regular bus service from [Nearest City] to Dangepia Village. Buses run every [X] hours. Journey time: approximately [X] minutes.")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h4", null, "\uD83D\uDEB6 Walking Distances"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p", null, "The village center is compact and walkable. Most locations are within 5-10 minutes walking distance from the central square.")))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("section", {
    style: {
      background: `#fed7d7`,
      padding: `2rem`,
      borderRadius: `8px`,
  ...
  }, "Emergency Locations"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", {
    style: {
      display: `grid`,
  ...
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("strong", null, "Police Station:"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("br", null), "Main Street, near Village Office", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("br", null), "Emergency: 110"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("strong", null, "Fire Station:"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("br", null), "Safety Street, west of center", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("br", null), "Emergency: 125"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("strong", null, "Medical Clinic:"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("br", null), "Health Street, central location", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("br", null), "Emergency: 115")))));
};
...
;
//# sourceMappingURL=component---src-pages-maps-js.js.map